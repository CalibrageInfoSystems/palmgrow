...
public class IdentifyProofsListAdapter extends RecyclerView.Adapter<IdentifyProofsListAdapter.MyHolder> {
    ...
    public IdentifyProofsListAdapter(Context mContext, List<IdentityProof> idProofsPair, LinkedHashMap<String, String> idProofsData) {
    ...
    @Override
    public IdentifyProofsListAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View bookingView = inflater.inflate(R.layout.adapteridproof, null);
    ...
    @Override
    public void onBindViewHolder(IdentifyProofsListAdapter.MyHolder holder, final int position) {
